<template>
    <div class="btn-group">
        <Button v-for="(item, i) in groupButtons" :key="i" :text="item.title" :class="{ active: activeIndex === i }" @click="activeIndex = activeIndex === i ? null : i" :btnClass="btnClass" :icon="item.icon" :iconPosition="item.iconPosition" />
    </div>
</template>
<script>
